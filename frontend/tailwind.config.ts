  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'drift-organic': 'driftOrganic var(--drift-duration, 35s) ease-in-out infinite',
      ...
      keyframes: {
        ...
        driftOrganic: {
          ...
          '25%': { transform: 'translate(calc(var(--drift-radius) * 0.7), calc(var(--drift-radius) * 0.3))' },
          '50%': { transform: 'translate(calc(var(--drift-radius) * 0.5), calc(var(--drift-radius) * -0.8))' },
          '75%': { transform: 'translate(calc(var(--drift-radius) * -0.6), calc(var(--drift-radius) * -0.4))' },
